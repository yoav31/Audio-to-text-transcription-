...
const TranscriptDownloadButton = ({transcription, language}) => {
    ...
    return (
        <Box style={{ 
            ...
            <Typography variant='h6' style={titleStyle}>Download Transcript:</Typography>
            <Box style={{ display: "flex", gap: "12px", flexWrap: "wrap", justifyContent: "center" }}>
                <Button 
                    sx={buttonStyle} 
                    startIcon={<BsFiletypeTxt />} 
                    onClick={() => handle_Download_Transcription_Txt(transcription)}
                >
                    .txt
                </Button>
                <Button 
                    ...
                    onClick={() => handle_Download_Transcription_Pdf(language, transcription)}
                >
                    .pdf
                </Button>
                <Button 
                    ...
                    onClick={() => handle_Download_Transcription_Word(transcription)}
                >
                    .doc
                </Button>
            </Box>
